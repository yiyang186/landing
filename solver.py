...
import optim
from data import sample_minibatch


class Solver(object):
    """
    A Solver encapsulates all the logic necessary for training
    image captioning models. The Solver performs stochastic gradient
    ...
    A Solver works on a model object that must conform to the following
    API:
